...
const About = () => {
  return (
    ...
    <Box p="2%" w="90%" m="auto" fontFamily="'Open Sans', sans-serif">
      ...
      <Box m='20px 0px' p="3"> <Image borderRadius="15" src="https://cdn1.cronometer.com/2021/landing/cronometer-staff-3.jpg" /></Box>
    ...
    <Box textAlign="center" fontFamily="Open Sans" display="block" marginBlockStart="1em" marginBlockEnd="1em" marginInlineStart="0px" marginInlineEnd="0px" color="#404040" fontSize={{base:'1em',md:'1em',lg:"1.125em"}} lineHeight="1.5em">Help us spread the good word about nutrition and become an affiliate.</Box>
     
    <Box p="6" Align="center" >
          <Button borderRadius='5px' border='1px solid orange' colorScheme='smokewhite' color="#ff763f" fontSize={{base:'1em',md:"1.41em",lg:'1.41em'}} lineHeight="1.5em" fontWeight="400" textTransform="uppercase">Become an Affiliate</Button>
    </Box>
      </Box>
    </Box>
